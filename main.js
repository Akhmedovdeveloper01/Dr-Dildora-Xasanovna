...
const translations = {
  uz: {
    ...
    'hero.subtitle':'Dr. Dildora Xasanovna — 8 yillik tajribaga ega endokrinolog. Diabet, qalqonsimon bez va gormonal buzilishlar bo\'yicha mutaxassis.',
    'hero.more':'Batafsil',
    ...
    'about.p1':'Dr. Dildora Xasanovna — Toshkent tibbiyot akademiyasini tamomlagan va endokrinologiya bo\'yicha 8 yildan ortiq klinik tajribaga ega mutaxassis. U diabet, qalqonsimon bez kasalliklari va gormonal buzilishlarni davolashda keng tajribaga ega.',
  ...
  ru: {
    ...
    'hero.subtitle':'Д-р Дилдора Хасановна — эндокринолог с 8-летним опытом. Специалист по диабету, щитовидной железе и гормональным нарушениям.',
    'hero.more':'Подробнее',
    ...
    'about.p1':'Д-р Дилдора Хасановна окончила Ташкентскую медицинскую академию и имеет более 8 лет клинического опыта в эндокринологии. Широкая практика в лечении диабета, заболеваний щитовидной железы и гормональных нарушений.',
  ...
  en: {
    ...
    'hero.subtitle':'Dr. Dildora Khasanova — Endocrinologist with 8 years of experience. Specialist in diabetes, thyroid disorders & hormonal imbalances.',
    ...
    'about.p1':'Dr. Dildora Khasanova graduated from Tashkent Medical Academy and has over 8 years of clinical experience in endocrinology. She has extensive expertise treating diabetes, thyroid diseases, and hormonal disorders.',
